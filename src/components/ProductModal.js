                ...
                <div className="image-tabs">
                  {images.map((image, index) => (
                    <img
                      ...
                      className={`img-thumbnail ${selectedImage === image ? 'selected' : ''}`}
                  ...
                  <div className='col-md-7 m-0 p-0'>
                    <div className='row m-0 p-0'>
                      ...
                      <div className='col-md-5 col-6 m-0 mdl des-view'>
                        <h5><img src='/images/plotSize.png' /> {data?.size}</h5>
                        <span>{data?.size_desc}</span>
                      </div>
                      <div className='col-md-4 col-6 m-0 des-view'>
                        <h5><img src='/images/area.png' /> {data?.area}</h5>
                      ...
                      <div className='col-6 m-0 p-0 mt-2 pb-2 pe-2 mob-res'>
                        ...
                        <span>{data?.rate} <br/> onwards {data?.rate_desc}</span>
                      </div>
                      <div className='col-6 m-0 p-0 mt-2 pb-2 pe-2 mob-res'>
                      ...
                      <div className='col-6 m-0 p-0 mt-2 pb-2 pe-2 mob-res'>
                        ...
                        <span>{data?.unit} <br/> {data?.unit_desc}</span>
                      </div>
                      <h4 className='m-0 p-0 mt-3 mb-2 amenities'>30+ Amenities</h4>
                      <div className='res-btn'>
                        <button>Know More</button>
                        <button className='active-btn'>Schedule Site Visit</button>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group1.png' /> {data?.liberary}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group2.png' /> {data?.pet}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group3.png' /> {data?.pool}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group4.png' /> {data?.ampitheare}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group5.png' /> {data?.tree}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group6.png' /> {data?.jogging}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group7.png' /> {data?.cycling}</p>
                      </div>
                      <div className='col-6 m-0 p-0 my-1'>
                        <p><img src='/images/Group8.png' /> {data?.basket}</p>
                      </div>
                    </div>
                  </div>
